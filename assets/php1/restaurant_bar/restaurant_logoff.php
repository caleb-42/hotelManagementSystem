...
$sql_logout = "UPDATE restaurant_sessions SET logged_off_time = CURRENT_TIMESTAMP , logged_on_state = 'LOGGED OFF' WHERE username='$user_name' AND id = $ID";
mysqli_query($dbConn, $sql_logout);
