...
app.directive('discountlist', ['$rootScope', '$filter', function ($rootScope, $filter) {
    return {
        ...
        <div ng-switch on = "details.discount.selected_discount" class = "w-100 h-70 ovflo-y mb-2 discountlist">
                    ...
                    <ul ng-if = "stocks.jslist.selectedObj">
                    ...
                    <h4 class = "center w-100 opac-50" ng-if = "!stocks.jslist.selectedObj"> Select an item</h4>
                    </div>
                    ...
                    jsonlist.then(function (result) {
                        ...
                        result.forEach(function (element) {
                            if (scope.details.discount.selected_discount == "total" && element.discount_item == "all") {
                                ...
                                console.log(element);
                            } else if (scope.details.discount.selected_discount == "item" && scope.stocks.jslist.selectedObj) {
                                if (element.discount_item == scope.stocks.jslist.selectedObj.item) {
                                    resultfiltered.push(element)
                                    console.log(element);
                                }
                            }else{
