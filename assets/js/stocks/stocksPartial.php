            ...
            <div ng-switch-default>
             <!--<div ng-controller = "ExampleCtrl">
                ...
                <div ng-switch on = "details.discount.selected_discount" class = "w-100 h-70 px-3 discountlist">
                    ...
                    <ul>
                        <li class = "row w-100 b-1 py-4">
                            <div class = "col-4"><div class = "center text-center btn-success"><h4 class = "py-2 m-0">12%</h4></div></div>
                            <div class = "col-8 text-right dark font-weight-bold pr-4 "><h4 class = "m-0"><span>N&nbsp;</span>3150</h4></div>
                        </li>
                    </ul>
                    </div>
                ...
                <button class="btn w-90 sechue">Add Contraints</button>
            </div>
            </div>
